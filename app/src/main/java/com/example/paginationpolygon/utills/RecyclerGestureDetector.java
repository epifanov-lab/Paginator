 ...
 */
final class RecyclerGestureDetector {
   ...
   * @see Handler#Handler()
   */
  public RecyclerGestureDetector(Context context, GestureDetector.OnGestureListener listener) {
   ...
   * @see Handler#Handler()
   */
  public RecyclerGestureDetector(Context context, GestureDetector.OnGestureListener listener, Handler handler) {
    if (handler != null) {
   ...
   * @see Handler#Handler()
   */
  public RecyclerGestureDetector(Context context, GestureDetector.OnGestureListener listener, Handler handler, boolean unused) {
